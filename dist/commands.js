...
Cypress.Commands.add(
  'ttClickIfElementExist',
  tt_click_if_element_exist_1.ttClickIfElementExist
)
Cypress.Commands.add(
  'ttCookieAllAcceptClick',
  tt_cookie_all_accept_1.ttCookieAllAcceptClick
)
...
Cypress.Commands.add(
  ...
  tt_every_internal_link_is_loading_1.ttEveryInternalLinkIsLoading
)
Cypress.Commands.add(
  'ttEveryInternalLinkStatusOk',
  tt_every_internal_link_status_ok_1.ttEveryInternalLinkStatusOk
)
Cypress.Commands.add(
  'ttGetInternalLinks',
  tt_get_internal_links_1.ttGetInternalLinks
)
...
Cypress.Commands.add(
  'ttRunTestifyBaseTests',
  tt_run_testify_base_tests_1.ttRunTestifyBaseTests
)
Cypress.Commands.add(
  'ttSetupConsoleErrorListener',
  tt_setup_console_error_listener_1.ttSetupConsoleErrorListener
)
Cypress.Commands.add('ttThreshold', tt_threshold_1.ttThreshold)
Cypress.Commands.add(
  'ttValidateAllImagesResponseStatusOk',
  tt_validate_all_images_response_status_ok_1.ttValidateAllImagesResponseStatusOk
)
Cypress.Commands.add(
  'ttValidateImprintClickable',
  tt_validate_imprint_clickable_1.ttValidateImprintClickable
)
Cypress.Commands.add(
  'ttValidateLanguageTag',
  tt_validate_language_tag_1.ttValidateLanguageTag
)
Cypress.Commands.add(
  'ttValidateNoGoogleServices',
  tt_validate_no_google_services_1.ttValidateNoGoogleServices
)
Cypress.Commands.add(
  'ttValidatePageContent',
  tt_validate_page_content_1.ttValidatePageContent
)
Cypress.Commands.add(
  'ttValidateSubpagesAndImages',
  tt_validate_subpages_and_images_1.ttValidateSubpagesAndImages
)
